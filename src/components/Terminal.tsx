...
export const commands: Command = [
  ...
  { cmd: "cv", desc: "download my CV in PDF form", tab: 11 },
  { cmd: "email", desc: "send an email to me", tab: 8 },
  { cmd: "help", desc: "check available commands", tab: 9 },
  { cmd: "ls", desc: "same as help :)", tab: 11 },
  { cmd: "history", desc: "view command history", tab: 6 },
  { cmd: "projects", desc: "view projects that I've coded", tab: 5 },
  { cmd: "talks", desc: "view talks that I've given", tab: 8 },
  { cmd: "pwd", desc: "print current working directory", tab: 10 },
  { cmd: "music", desc: "see what I'm listening to right now", tab: 8 },
  { cmd: "blog", desc: "read some of the drivel that i've written", tab: 9 },
  { cmd: "photos", desc: "view some of the photos that i've taken", tab: 9 },
